    ...
    <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample2">
                ...
                <div class="row mt-4">
                    <div class="col-lg-4">
                        <p>Harga Barang</p>
                        <input type="number" class="form-control" id="harga" name="harga" placeholder="Harga Rp." readonly required>
                    </div>
                    <div class="col-lg-4">
                        <p>Qty Masuk</p>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="fix_totalHarga[]" readonly value="<?php echo number_format($subtotalHarga,1) ?>"></td>
                            <td>
                                <a href='#editTempMasuk' class='btn btn-warning btn-block' data-toggle='modal' data-id='<?php echo $id_masuk_temp ?>'><i class="fa fas-pencil"></i> Edit</a>
                            </td>
                            <td>
                                <a href="action/temp_delete_brg_masuk.php?id_masuk_temp=<?php echo $id['id_masuk_temp'] ?>" class="btn btn-danger btn-block" name="delete" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><input type="number" class="form-control" id="totalHarga" name="totalHarga" value="<?php echo $totalHarga ?>" readonly></td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
...
<script> 
  $(document).ready(function(){
    $('#editTempMasuk').on('show.bs.modal', function (e) {
      ...
      var id_masuk_temp       = $(e.relatedTarget).data('id');
