...
<!-- modal edit -->
        ...
        <div class="modal-body">
          <form method="POST" action="action/req_hapus_keluar.php">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8"><input type="text" class="form-control" name="" value="<?php echo $id['qty_keluar'] ?>" readonly></div>
              </div>
            </div>
            <!-- bagian request -->
            <hr>
