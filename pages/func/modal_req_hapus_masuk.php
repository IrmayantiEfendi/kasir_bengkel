...
<!-- modal edit -->
        <div class="modal-header">
          <h3 class="modal-title">Request Edit Pembelian</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <form method="POST" action="action/req_hapus_masuk.php">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-8"><input type="text" class="form-control" name="" value="<?php echo $id['qty_masuk'] ?>" readonly></div>
              </div>
            </div>
            <!-- bagian request -->
            <hr>
            ...
            <div class="modal-footer">
              <input type="submit" class="btn btn-danger" name="hapus" value="Kirim Request Hapus">
