                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <form method="GET">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>Pembelian Barang Harian</td>
                                            <td><input type="date" class="form-control" id="tgl_mulai"></td>
                                            <td><input type="date" class="form-control" id="tgl_selesai"></td>
                                            <td>
                                                <center><a href="#" id="laporanHarian" onclick="getLaporanBeliHarian()"><i class="fas fa-fw fa-eye fa-2x" aria-hidden="true"></i></a></center>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>Pembelian Barang Bulanan</td>
                                            <td>
                                                <?php
                                                // tahun
                                            ...
                                            <td>
                                                <center><a href="#" onclick="getLaporanBulanan()"><i class="fas fa-fw fa-eye fa-2x" aria-hidden="true"></i></a></center>
                                            </td>
                                        </tr>
                                    </form>
                                </tbody>
...
<!-- SCRIPT FUNCTION -->
<script>
    function getLaporanBeliHarian() {
        var username = $("#username").val();
        var tgl_mulai = $("#tgl_mulai").val();
        var tgl_selesai = $("#tgl_selesai").val();
        window.open('PDF/laporan_masuk_harian.php?tgl_mulai='+tgl_mulai+'&&tgl_selesai='+tgl_selesai+'&&username='+username);
    }
    ...
    function getLaporanBulanan() {
        ...
        window.open('PDF/laporan_masuk_bulanan.php?thn_mulai='+thn_mulai+'&&thn_selesai='+thn_selesai+'&&bln_mulai='+bln_mulai+'&&bln_selesai='+bln_selesai+'&&username='+username);
    }
</script>