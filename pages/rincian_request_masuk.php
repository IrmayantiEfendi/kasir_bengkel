...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Request Ubah Pembelian</h1>
  </div>
  <!-- Content Row -->
  <div class="row">
    <div class="col-lg-12">
          ...
          <div class="card-body">
            ...
            <form method="GET">
                        ...
                        if (empty($_GET['kolom_cari'])) {
                            $kolom_cari     = "";
                            $result_count   = mysqli_query($conn, "SELECT * FROM req_tb_masuk LEFT JOIN databarang ON req_tb_masuk.kode_barang=databarang.kode_barang LEFT JOIN tb_user ON req_tb_masuk.id_user_masuk=tb_user.id_user ORDER BY id_masuk DESC");
                        } else {
                            $kolom_cari     = $_GET['kolom_cari'];
                            $result_count   = mysqli_query($conn, "SELECT * FROM req_tb_masuk LEFT JOIN databarang ON req_tb_masuk.kode_barang=databarang.kode_barang LEFT JOIN tb_user ON req_tb_masuk.id_user_masuk=tb_user.id_user WHERE req_tb_masuk.no_trans_beli LIKE '%$kolom_cari%' OR req_tb_masuk.tgl_masuk LIKE '%$kolom_cari%' OR req_tb_masuk.kode_barang LIKE '%$kolom_cari%' OR databarang.nama_barang LIKE '%$kolom_cari%' OR tb_user.username LIKE '%$kolom_cari%' ORDER BY id_masuk DESC");
                        }
                        ...
                        <div class="row row mt-4">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    if (empty($_GET['kolom_cari'])) {
                                        $kolom_cari = "";
                                        $selectTemp = mysqli_query($conn, "SELECT * FROM req_tb_masuk LEFT JOIN databarang ON req_tb_masuk.kode_barang=databarang.kode_barang LEFT JOIN tb_user ON req_tb_masuk.id_user_masuk=tb_user.id_user ORDER BY id_masuk DESC LIMIT $offset, $total_records_per_page");
                                    } else {
                                        $kolom_cari = $_GET['kolom_cari'];
                                        $selectTemp = mysqli_query($conn, "SELECT * FROM req_tb_masuk LEFT JOIN databarang ON req_tb_masuk.kode_barang=databarang.kode_barang LEFT JOIN tb_user ON req_tb_masuk.id_user_masuk=tb_user.id_user AND req_tb_masuk.id_user_masuk=tb_user.id_user WHERE req_tb_masuk.no_trans_beli LIKE '%$kolom_cari%' OR req_tb_masuk.tgl_masuk LIKE '%$kolom_cari%' OR req_tb_masuk.kode_barang LIKE '%$kolom_cari%' OR databarang.nama_barang LIKE '%$kolom_cari%' OR tb_user.username LIKE '%$kolom_cari%' ORDER BY id_masuk DESC LIMIT $offset, $total_records_per_page");
                                    }
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: blue;"><?php echo $id['req_qty_masuk']; ?></td>
                                            ...
                                            if($id['status'] == ''){
                                                ...
                                                ?>
                                                    <td>
                                                        <a href="#approve" class="<?php echo $btn ?>" data-toggle="modal" data-id_req_masuk="<?php echo $id['id_req_masuk'] ?>" data-kategori="<?php echo $id['kategori'] ?>" data-page_no="<?php echo $page_no ?>" data-kolom_cari="<?php echo $kolom_cari ?>"><i class="<?php echo $icon; ?>" aria-hidden="true"></i> <?php echo $text; ?></a>
                                                    </td>
                                                <?php
...
<script>
    $(document).ready(function() {
        $('#approve').on('show.bs.modal', function(e) {
            ...
            var id_req_masuk = $(e.relatedTarget).data('id_req_masuk');
            ...
            $.ajax({
                type: 'GET',
                url: 'func/modal_acc_req_masuk.php',
                data: 'id_req_masuk='+id_req_masuk+'&kategori='+kategori+'&page_no='+page_no+'&kolom_cari='+kolom_cari,
